<x-layout>
	...
	<form action="{{route('accounts.store')}}" method="post">
		...
		@else
		<form action="{{route('accounts.store.add_device')}}" method="post">
			...
			<div class="mb-3">
				...
				<textarea id="obs" class="form-control" name="obs" placeholder="Datos adicionales con respecto al cliente y su pago." id="floatingTextarea"></textarea>
			</div>
